...
#-----------------------------------#
"""Task One: Creating a Dictionary"""
#-----------------------------------#
...
salary['al'] = 20000
salary['bo'] = 50000
salary[7] = ('Joke', 'Chen', 'Bond') #key and value can be any data type. Numbers cannot start with 0.
...
#---Overwriting dictionary values and doing operations with values---#
...
#---------------------------------#
"""Task Three: Modifying Values"""
#---------------------------------#

#---Looking up a value---#
print(phone_book['Aminat'])
...
#-----------------------------------------------------------------------------------------#
"""Task Four and Five: Retrieve keys and values from a dictionary and convert to a list"""
#-----------------------------------------------------------------------------------------#
...
#make it a list to be able to use methods on the list and to retrieve items

print(phone_book_keys[0])
#retrieveing the first value

#--------------------------------#
"""Task Six: Testing for errors"""
#--------------------------------#
